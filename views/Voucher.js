  ...
  return (
      <NativeBaseProvider>
        <View style={{backgroundColor:"#000",flex:1,paddingLeft:10, paddingRight:10}}>
          ...
          <View style={{flex:0.4}}>
            <Radio.Group onChange={nextValue=>{
            ...
            <View style={{display:"flex", flexDirection:"row", backgroundColor:"#fff",borderRadius:20, marginTop:10}}>
              ...
              {/* <Checkbox
                ...
                /> */}
                <Radio  value="1" my={1} style={{width:20, height:20}} ><Text style={{opacity:0}}>a</Text></Radio>
            ...
            <View style={{display:"flex", flexDirection:"row", backgroundColor:"#fff",borderRadius:20, marginTop:10}}>
              ...
              <Radio value="2" my={1} style={{width:20, height:20}} ><Text style={{opacity:0}}>a</Text></Radio>
          ...
          <View style={{flex:0.4}}>
            ...
            <Radio.Group onChange={nextValue=>{
              ...
              <View style={{display:"flex", flexDirection:"row", backgroundColor:"#fff",borderRadius:20, marginTop:10}}>
                ...
                <View style={{flex:0.2, alignItems:"center",justifyContent:"center"}}>
                <Radio value="15" my={2} style={{width:20, height:20}} ><Text style={{opacity:0}}>a</Text></Radio>
              </View>
              </View>
              ...
              <View style={{flex:0.2, alignItems:"center",justifyContent:"center"}}>
               <Radio value="10" my={2} style={{width:20, height:20}} ><Text style={{opacity:0}}>a</Text></Radio>
              </View>
              </View>
              </Radio.Group>
            </ScrollView>
          ...
          <TouchableOpacity style={{backgroundColor:"#2cc167", width:"100%",height:50, borderRadius:5, borderColor:"#fff",alignSelf:"center",alignItems:"center", justifyContent:"center"}} onPress={()=>navigation.navigate('OderView',{discount:discount,discount2:discount2})}>
