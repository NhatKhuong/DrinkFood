...
export default function Detail({navigation}) {
  ...
  return (
    <View style={{paddingLeft:15,backgroundColor:'#000', paddingRight:15,flex:1}}>
      <View style={{display:'flex',flexDirection:'row', justifyContent:'space-between',flex:0.1}}>
      ...
      <View style={{display:'flex',flexDirection:'row', justifyContent:'space-between',flex:0.1}}>
        ...
        <View>
            <TouchableOpacity style={{backgroundColor:"#2cc167", width:240,height:45, borderRadius:20, borderWidth:1,alignItems:"center", justifyContent:"center"}} onPress={()=>navigation.navigate('Cart')}>
